...
<table class="table">
  ...
  <br>
  <div class="progress">
    <div class="progress-bar progress-bar-striped progress-bar-animated" style="width:75%">3 out of 4</div>
  </div>
  <br>
 <a href="{{ url('/input3') }}" class="btn btn-danger"> Previews</a>
