...
<table class="table">
    <thead>
      <tr>
        ...
        <th>Collected During the year (2)</th>
        <th>Remitted During the Year (3)</th>
  ...
  <br>
  <div class="progress">
    <div class="progress-bar progress-bar-striped progress-bar-animated" style="width:100%">4 out of 4</div>
  </div>
  <br>
 <a href="{{ url('/input4') }}" class="btn btn-danger"> Previews</a>
  <a href="{{ url('/input5') }}" class="btn btn-danger"> Next</a>
